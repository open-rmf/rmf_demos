          ...
          <CardContent>
            <Grid container>
              <Grid item xs={12}>
                ...
                <Grid item xs={12}><Button variant="outlined" onClick={() => handleCancel(taskState.task_id)} disabled={ currentTaskStatus === ('Cancelled' || 'Completed' || 'Failed') ? true : false }>Cancel Task</Button></Grid>
            </Grid>
          </CardContent>
