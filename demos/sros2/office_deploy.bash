...
ros2 security generate_artifacts -k $WORKSPACE/keystore -p $WORKSPACE/install/demos/share/demos/sros2/policies/office.policy.xml
sleep 2
...
tmux send-keys -t 1 "ros2 run rmf_traffic_ros2 rmf_traffic_schedule --ros-args --params-file $WORKSPACE/install/demos/share/demos/sros2/office.params.yaml --enclave /office/rmf_traffic_schedule_node" Enter
sleep 2

## Pane 2 ##

tmux send-keys -t 2 "source $WORKSPACE/sros2_environment.bash" Enter
tmux send-keys -t 2 "ros2 run building_map_tools building_map_server $WORKSPACE/install/rmf_demo_maps/share/rmf_demo_maps/office/office.building.yaml --ros-args --enclave /office/building_map_server" Enter
sleep 2

## Pane 3 ##

tmux send-keys -t 3 "source $WORKSPACE/sros2_environment.bash" Enter
tmux send-keys -t 3 "ros2 run rmf_schedule_visualizer rviz2 -r 10 -m L1 --ros-args --params-file $WORKSPACE/install/demos/share/demos/sros2/office.params.yaml --enclave /office/rviz2_node" Enter
sleep 2

## Pane 4 ##

tmux send-keys -t 4 "source $WORKSPACE/sros2_environment.bash" Enter
tmux send-keys -t 4 "ros2 run building_systems_visualizer building_systems_visualizer -m L1 --ros-args --params-file $WORKSPACE/install/demos/share/demos/sros2/office.params.yaml --enclave /office/building_systems_visualizer" Enter
sleep 2

## Pane 5 ##

tmux send-keys -t 5 "source $WORKSPACE/sros2_environment.bash" Enter
tmux send-keys -t 5 "ros2 run fleet_state_visualizer fleet_state_visualizer -m L1 --ros-args --params-file $WORKSPACE/install/demos/share/demos/sros2/office.params.yaml --enclave /office/fleet_state_visualizer" Enter
sleep 2

## Pane 6 ##

tmux send-keys -t 6 "source $WORKSPACE/sros2_environment.bash" Enter
tmux send-keys -t 6 "rviz2 -d $WORKSPACE/install/demos/share/demos/include/office/office.rviz --ros-args --enclave /office/rviz2" Enter
sleep 2
...
tmux send-keys -t 8 "gzserver --verbose -s libgazebo_ros_factory.so -s libgazebo_ros_init.so $WORKSPACE/install/rmf_demo_maps/share/rmf_demo_maps/maps/office/office.world --ros-args --enclave /office/gzserver" Enter
sleep 2

## Pane 9 ##

tmux send-keys -t 9 "source $WORKSPACE/gazebo_environment.bash" Enter
tmux send-keys -t 9 "gzclient --verbose $WORKSPACE/install/rmf_demo_maps/share/rmf_demo_maps/maps/office/office.world" Enter
sleep 2
...
tmux send-keys -t 10 "ros2 run rmf_fleet_adapter full_control --ros-args -r __node:=tinyRobot_fleet_adapter --params-file $WORKSPACE/install/demos/share/demos/sros2/office.params.yaml --enclave /office/tinyRobot_fleet_adapter" Enter
sleep 2

## Pane 0 ##

source $WORKSPACE/sros2_environment.bash
ros2 run rmf_fleet_adapter robot_state_aggregator --ros-args -r __node:=tinyRobot_state_aggregator --params-file $WORKSPACE/install/demos/share/demos/sros2/office.params.yaml --enclave /office/tinyRobot_state_aggregator
