...
class TaskRequester(Node):
    ...
    def __init__(self, argv=sys.argv):
        ...
        parser.add_argument('-F', '--fleet', type=str, required=True,
        ...
        # Construct task
        # Note that charging tasks should be direct tasks
        msg = ApiRequest()
        msg.request_id = "charge_battery_" + str(uuid.uuid4())
        payload = {}
        ...
        request["category"] = "charge_battery"
